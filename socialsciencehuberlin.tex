...
\usepackage[style=socialsciencehuberlin, backend=biber]{biblatex}
...
\clearscrheadfoot
\rohead{\texttt{bib}\LaTeX-style \texttt{socialscience-huberlin \edtoversionblx}}%
...
% \DeclareBibliographyCategory{ancient}
% \DeclareBibliographyCategory{frgancient}
% \DeclareBibliographyCategory{corpus}
% \DeclareBibliographyCategory{uniqueme}
% \DeclareBibliographyCategory{serieseditor}

% \addtocategory{ancient}{Cic:Tusc,Plut:Timaios,Plotin}
% \addtocategory{frgancient}{Cato:frg}
% \addtocategory{corpus}{CIL}
% \addtocategory{uniqueme}{Prokl:Diehl,Prokl:Dodds,Prokl:Saffrey}
% \addtocategory{serieseditor}{Defaux2017}
...
\newrobustcmd\edtobibexamplefile[1]{%
\inputexamplebibfile[listing options={style = extblxstylebibtex,linerange={#1}}]{editiontopoi-examples.bib}}
...
\newcommand*{\gitbaseurl}{https://github.com/LukasCBossert/biblatex-socialscience-huberlin}
\newcommand*{\biber}{Biber}
\newcommand*{\gitissuelink}[1]{%
  \href{\gitbaseurl/issues/#1}{issue \##1 on github}}

\titlepage{%
  title    = {The \sty{biblatex-socialsciencehuberlin} style},
  subtitle = {Style used for social science at the Humbold-Universität zu Berlin},
  url      = {\gitbaseurl},
  author   = {Lukas C. Bossert},
  link     = {lukas@digitales-altertum.de},%
  revision = {\socialsciencehuberlinversion},
  date     = {{\socialsciencehuberlindate}},
}

\hypersetup{%
  pdftitle    = {The biblatex-'socialscience|huberlin' style},
  pdfsubject  = {\sty{biblatex}-style 'socialscience|huberlin'},
...
\subsection{About}
The \sty{biblatex-socialsciencehuberlin} style provides the citation and bibliography styles used at the Department of Social Science at the Humboldt-Universität zu Berlin.
...
\fnurl{https://ctan.org/pkg/biblatex-socialsciencehuberlin}
